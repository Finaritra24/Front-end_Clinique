...
export default function AjoutAchatPatient() {
  ...
  const handleSubmit = (event) => {
    ...
    const data = {
      ...
      idcategorierecette:selectedType2,
      idpatient:selectedType,
    };
    sendFormData(data);
  };
        ...
        <div className="flex flex-column md:flex-row">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <GenerDropdown nomClass="CategorieRecette" labels="nom" selectedTypesRef={selectedTypesRef2} />
{/* Passez la référence selectedTypesRef */}{/* Passez la référence selectedTypesRef */}
          ...
          <div className="flex flex-wrap  gap-2">
              ...
              <GenerDropdown nomClass="Patient" labels="nom" selectedTypesRef={selectedTypesRef} /> 
            </div>
          <div className="flex flex-wrap gap-2">
