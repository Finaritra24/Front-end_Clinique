...
// import { useNavigate } from 'react-router-dom';
export default function ModifDepenseClinique() {
    const navigate=useNavigate();
    const [depense, setDepense] = useState(null);
    useEffect(() => {
      if (depense !== null) {
        setNom(depense.nom);
        setPrix(depense.prix);
      }
    }, [depense]);

    useEffect(() => {
      fetch('http://localhost:8081/getObject-Depense', { credentials: 'include' })
  ...
  const handleSubmit = (event) => {
    ...
    const data = {
      ...
      idcategoriedepense:selectedType
    };
    sendFormData(data);
  };
    ...
    const sendFormData = (data) => {
      fetch('http://localhost:8081/modif-Depense', {
        method: 'POST',
                     ...
                     <div className="flex flex-column md:flex-row">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <GenerDropdown nomClass="CategorieDepense" labels="nom" selectedTypesRef={selectedTypesRef} /> {/* Passez la référence selectedTypesRef */}
                        </div>
                        <div className="flex flex-wrap  gap-2">
